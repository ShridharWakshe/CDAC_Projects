...
('C_110','MICROSOFT', 'BILL',86327378, 'BILL@MICROSOFT.com','TIME SQUARE', 'CHINA', 4000356 );
...
SELECT Customer_ID,Contact_name, City  -- (sub query)
FROM Customers WHERE EXISTS
   (SELECT *FROM Customers WHERE city='CHINA');
