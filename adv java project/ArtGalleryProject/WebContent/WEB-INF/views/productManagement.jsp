			...
			<%
				...
				for (int i=0;i<prodList.size();i++) {
					if (request.getParameter(Integer.toString(prodList.get(i).getPid())) != null){
						...
						String redirectURL = "http://localhost:8081/ArtGalleryProject/admin/updateProduct";
						response.sendRedirect(redirectURL);
					}
				}
			%>
			<br>
			<a href="addProduct"><button class="btn info v">Add Product</button></a>
			<a href="delProduct"><button class="btn info-delete v">Delete Product</button></a>
