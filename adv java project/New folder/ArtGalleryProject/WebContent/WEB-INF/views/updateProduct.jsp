	...
	<body>
			...
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="http://localhost:8081/ArtGalleryProject/admin">Home</a></li>
					<li><a href="http://localhost:8081/ArtGalleryProject/admin/productManagement">Product Management</a></li>
					<li><a href="http://localhost:8081/ArtGalleryProject/admin/customerManagement">Customer Management</a></li>
				</ul>
		...
		<h1 class="b">Update Product Information:</h1>
		<%
		...
		<form method="post" class ="a">
			...
			<br><br>
				...
				if (request.getParameter("update") != null) {
					...
					String redirectURL = "http://localhost:8081/ArtGalleryProject/admin/productManagement";
				response.sendRedirect(redirectURL);	
								
					}}
				%>

			<input type="submit" name="update" value="Update" class="btn update-customer" />
			<a href="productManagement"  class="btn update-customer">Back</a>
		</form>
